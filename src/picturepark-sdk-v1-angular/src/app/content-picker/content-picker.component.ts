...
import { ContentItemSelectionService, BasketService, ContentModel, ContentBrowserComponent, SearchHandler } from '@picturepark/sdk-v1-angular-ui';
...
export class ContentPickerComponent implements OnInit, OnDestroy {
  ...
  public ngOnInit() {
    ...
    this.searchHandler = new SearchHandler(this.contentService);
